    ...
    <div className="glass rounded-3xl p-8 shadow-2xl">
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex-1">
          <div className="flex items-center gap-3 mb-3">
            ...
            <h1 className="text-4xl font-bold text-theme-card">{goal.name}</h1>
          </div>

          {/* Dates */}
          {(goal.startDate || goal.finishDate) && (
            <div className="flex items-center gap-6 text-theme-muted text-sm ml-16">
              {goal.startDate && (
      ...
      <div className="grid grid-cols-3 gap-4 mb-6">
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs font-semibold text-theme-muted uppercase">{viewData.label} Goal</span>
          </div>
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-2xl p-4 border border-white/30">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs font-semibold text-theme-muted uppercase">Progress</span>
          </div>
          <div className="text-2xl font-bold text-theme-card">{progressPercentage.toFixed(0)}%</div>
        </div>
      </div>
      ...
      <div className="mt-6 pt-6 border-t border-white/30 flex items-center justify-around">
        <div className="text-center">
          <div className="text-2xl font-bold text-theme-card">{subjects.length}</div>
          <div className="text-xs text-theme-muted flex items-center justify-center gap-1 mt-1">
