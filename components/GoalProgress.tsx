    ...
    <div className="glass rounded-3xl p-4 sm:p-8 shadow-2xl relative">
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 sm:gap-3 mb-3">
            ...
            <h1 className="text-2xl sm:text-4xl font-bold text-theme-card">{goal.name}</h1>
          </div>

          {/* Dates */}
          {(goal.startDate || goal.finishDate) && (
            <div className="flex items-center gap-2 sm:gap-6 text-theme-muted text-xs sm:text-sm ml-0 sm:ml-16 flex-wrap">
              {goal.startDate && (
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6">
        ...
        <div className="bg-white/20 backdrop-blur-sm rounded-xl sm:rounded-2xl p-3 sm:p-4 border border-white/30">
          <div className="flex items-center gap-1 sm:gap-2 mb-2">
            ...
            <span className="text-[10px] sm:text-xs font-semibold text-theme-muted uppercase">Progress</span>
          </div>
          <div className="text-lg sm:text-2xl font-bold text-theme-card">{progressPercentage.toFixed(0)}%</div>
        </div>
      </div>
      ...
      <div className="space-y-4 mb-6">
        {viewData.goal > 0 ? (
          <div>
            ...
            <div className="w-full bg-white/20 rounded-full h-6 overflow-hidden shadow-inner">
              <div
        ...
        {daysInfo && (
          <div>
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-semibold text-theme-card">Timeline Progress</span>
              <span className="text-sm text-theme-muted">
      ...
      <div className="mt-6 pt-6 border-t border-white/30 flex items-center justify-around">
        <div className="text-center">
          <div className="text-xl sm:text-2xl font-bold text-theme-card">{subjects.length}</div>
          <div className="text-[10px] sm:text-xs text-theme-muted flex items-center justify-center gap-1 mt-1">
